...
const Footer = () => {
  ...
  const devInfo = {
    ...
    supportText: "Olá! Gostaria de suporte técnico para o Valen Studio."
  };
      ...
      <div className="footer-content">
        <div className="footer-top">
          <div className="footer-brand">
            <span className="footer-logo">Valen Studio</span>
        ...
        <div className="footer-bottom">
          <div className="footer-legal">
            <p>© {currentYear} Valen Studio. Licenciado para Melissa Dimas.</p>
