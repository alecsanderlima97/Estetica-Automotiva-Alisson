...
const Footer = () => {
  ...
  const devInfo = {
    ...
    supportText: "Olá! Gostaria de suporte técnico para o Sistema de Estética Automotiva."
  };
      ...
      <div className="footer-content">
        <div className="footer-top">
          <div className="footer-brand">
            <span className="footer-logo" style={{ color: '#ffffff' }}>Estética Automotiva</span>
        ...
        <div className="footer-bottom">
          <div className="footer-legal">
            <p>© {currentYear} Estética Automotiva.</p>
